...
\IEEEauthorblockA{\textit{Graduate School of Integrated Science and Technology}\\
...
% Hugging Face1 is a platform where various open LLM models are available. LM Studio2 is a platform to test and integrate LLM available on Hugging Face into a locally available system on ordinary computing devices, even without powerful GPUs
